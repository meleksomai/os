...
function InputGroup({ className, ...props }: React.ComponentProps<"div">) {
  return (
    // biome-ignore lint/a11y/useSemanticElements: fine as a div with role="group"
    <div
      className={cn(
...
function InputGroupAddon({
  ...
  return (
    // biome-ignore lint/a11y/useSemanticElements: fine as a div with role="group"
    // biome-ignore lint/a11y/useKeyWithClickEvents: fine as a div with role="group"
    // biome-ignore lint/a11y/noNoninteractiveElementInteractions: fine as a div with role="group"
    <div
