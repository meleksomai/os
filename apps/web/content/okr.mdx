...
_Decrease by 40% the total number of support calls per 100,000 sessions in our platform by the end of the year._
...
From the start, I tried to frame OKRs not as a doctrine, but as an experiment with a high upside: If we defined them _carefully_, used them _consistently_, and _wove_ them into our engineering fabric,
