...
export function ContactForm() {
  ...
  const showsResult = displayState === "success" || displayState === "error";
      ...
      <div className="w-full">
        <div className="flex flex-col justify-center">
          ...
          >
            ...
            <div
              aria-hidden={showsResult}
              className={cn(
                "transition-all duration-500",
                showsResult
                  ? "pointer-events-none invisible h-0 -translate-y-4 opacity-0"
            ...
            <div
              ...
              className={cn(
                ...
                displayState === "success"
                  ...
                  : "pointer-events-none invisible absolute translate-y-4 opacity-0"
              )}
              inert={displayState !== "success"}
              role="status"
            >
            ...
            {/* State: Error */}
            <div
              aria-hidden={displayState !== "error"}
              className={cn(
                "transition-all duration-500",
                displayState === "error"
                  ? "visible translate-y-0 opacity-100"
