...
import {
  type SubscribeState as NewsletterState,
...
export function ContactForm() {
  ...
  // Adapter converts React's (prevState, formData) -> server fn's ({ data }).
  const [actionState, formAction, isPending] = useActionState(
    (_prev: NewsletterState, formData: FormData) =>
      subscribeToNewsletterFn({ data: formData }),
    initialState
  );
