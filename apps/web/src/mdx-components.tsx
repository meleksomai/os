...
import { Image, type ImageProps } from "@workspace/ui/components/image";
...
function isFootnotesSection(props: HTMLAttributes<HTMLElement>) {
...
export const components = {
  ...
  a: ({ href, ...props }: AnchorProps) => {
    ...
    if (href?.startsWith("/")) {
      return <Link className={className} to={href} {...props} />;
    }
    if (href?.startsWith("#")) {
