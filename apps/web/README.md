...
| Contract | `packages/emailing/*.contract.test.ts` (Vitest) | the real API, with a dedicated Resend audience | scheduled `contract` workflow, or `pnpm --filter @workspace/emailing test:contract` |
