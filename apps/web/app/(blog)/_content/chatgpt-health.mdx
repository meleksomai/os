...
Unfortunately for Google, these teams are fragmented. Google Health still carries institutional scars from its 2008 failure. DeepMind is focused on [scientific discovery](https://deepmind.google/science/) and [biology](https://deepmind.google/blog/alphaproteo-generates-novel-proteins-for-biology-and-health-research/) not consumer health applications, though they were behind Gemini 3. And while [Google Health's AMIE](https://www.nature.com/articles/s41586-025-08866-7) team has made impressive strides in diagnostic reasoning (arguably ahead of OpenAI in clinical evaluation benchmarks), they have yet to translate that research into a consumer-facing product.
