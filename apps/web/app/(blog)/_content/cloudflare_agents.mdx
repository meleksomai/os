---
title: Building an Agent-First Email Assistant with Cloudflare Durable Objects
subtitle: Exploring agentic architectures using Cloudflare Workers and Durable Objects
featured: true
