...
> [!WARNING]  
> Cloudflare email routing currently does not support sending multiple emails directly from Durable Objects. Therefore, the email sending tool uses an external SMTP service (e.g., SendGrid, Postmark) to send emails.
