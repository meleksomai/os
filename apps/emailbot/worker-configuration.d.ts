/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: 6ead25587cdd4e05a57c9ffebbc1c1b7)
...
declare namespace Cloudflare {
	...
	interface Env {
		EMAIL_LOOKUP_KV: KVNamespace;
		EMAIL_ROUTING_DESTINATION: string;
		EMAIL_ROUTING_ADDRESS: string;
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "EMAIL_ROUTING_DESTINATION" | "EMAIL_ROUTING_ADDRESS" | "NOTION_API_KEY" | "CLOUDFLARE_AI_GATEWAY_TOKEN" | "CLOUDFLARE_AI_GATEWAY_ID" | "OPENAI_API_KEY" | "RESEND_API_KEY">> {}
}
